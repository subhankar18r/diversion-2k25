...
export class RoutesPanel {
  ...
  private _getWebviewContent(webview: Webview, extensionUri: Uri) {
    ...
    const stylesUri = getUri(webview, extensionUri, ["webview-ui", "build", "assets", "jsx-runtime.css"]);
    // The JS file from the React build output
    const runtimeScriptUri = getUri(webview, extensionUri, ["webview-ui", "build", "assets", "jsx-runtime.js"]);
